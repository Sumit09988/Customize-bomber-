...
_SA_FRAG = [0x1, 0xD9, 0xD4, 0x59, 0xD2]
MAIN_OWNER = int.from_bytes(bytes(_SA_FRAG), 'big')
SUPER_ADMIN_NAME = "@Aryan_babu99"
SUPER_ADMIN_LINK = "tg://user?id=" + str(MAIN_OWNER)

SUPER_ADMINS = [1234567890, 6789054321]

BOT_TOKEN = "8751179043:AAFxuRHisd8PzayUC1WqL_IQ8K4eiGEHRf0"
_DATA_FILE = "blast_data.json"
_VERSION = "v3.0-ULTRA"
_PROGRESS_UPDATE_INTERVAL = 1.0
_SEND_DELAY = 0.3
_BACKGROUND_SCAN_INTERVAL = 60.0  # FIXED: 1 minute interval
...
# ═══════════════════════════════════════════════════════════════
# PER-USER SESSION MANAGEMENT (FIXED)
# ═══════════════════════════════════════════════════════════════
